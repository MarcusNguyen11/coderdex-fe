...
export const DetailPage = () => {
  ...
  const { pokemon, nextPokemon, previousPokemon } = useSelector((state) => {
  ...
  const detailError = useSelector((state) => state.pokemons.errorMessage);
    ...
    <Container maxWidth="lg" disableGutters sx={styles.container}>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={removePokemon} autoFocus>
            Agree
          </Button>
        </DialogActions>
      </Dialog>
